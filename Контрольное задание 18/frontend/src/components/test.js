...
export class Test {
    ...
    showQuestion() {
        ...
        const that = this;
        const choseOption = this.userResult.find(item => item.questionId === activeQuestion.id);
        ...
        activeQuestion.answers.forEach(answer => {
            ...
            if (choseOption && choseOption.chosenAnswerId === answer.id) {
        ...
        if (choseOption && choseOption.chosenAnswerId) {
            this.nextButtonElement.removeAttribute('disabled');
        } else {
            this.nextButtonElement.setAttribute('disabled', 'disabled');
            this.passButtonElement.onclick = this.move.bind(this, 'pass');
            this.passButtonElement.classList.remove('pass-disabled');
        }
    ...
    chooseAnswer() {
        ...
        this.passButtonElement.className = 'pass-disabled';
    }
